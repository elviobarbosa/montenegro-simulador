...
function cvcrm_request($endpoint, $cache_key, $timeout = 15, $cache_ttl = 300) {
  $email = get_option('terreno_cvcrm_email', '');
...
function cvcrm_get_unidade($request) {
    ...
    $base_url = cvcrm_get_base_url();
    $url = "{$base_url}/api/v1/cadastros/empreendimentos/{$empreendimento}/unidades/{$id}";
...
function cvcrm_get_tabela_preco($request) {
    ...
    $base_url = cvcrm_get_base_url();
    $url = "{$base_url}/api/v1/cadastros/empreendimentos/{$empreendimento_id}/tabelasdepreco/{$tabela_id}";
